...
public class QuestServiceImpl extends QuestServiceGrpc.QuestServiceImplBase {
    ...
    private QuestEntity convertToProto(Quest quest) {
            ...
            if (quest.getAssignee() != null) {
                builder.setAssignee(quest.getAssignee().getId());
            }
